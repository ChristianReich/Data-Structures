...
class List:
    ...
    def _swap(self, i, j):
        ...
        temp_i = self._values[i]
        self._values[i] = self._values[j]
        self._values[j] = temp_i
    ...
    def clean(self):
        ...
        for i in range(len(self._values)):
            if self._values[i] in clear_list:
                index_list.append(i)
            else:
                clear_list.append(deepcopy(self._values[i]))
        LENGTH = len(index_list)
        for ind in range(-1, (-LENGTH - 1), -1):
            self._values.pop(index_list[ind])
        return
